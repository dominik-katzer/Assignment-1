...
abstract: |
  | This is a paper stub generated out of a template repository. It repliactes the association of national income per capita with life expectancy that has become known as the 'Preston Curve'. Dominik Katzer extended the original paper. See the introduction for further information.
  | \vspace{8cm}
...
For passing the first assignment I changed the following things.^[See the respective sections] I changed the front page and added a page after the conclusion. Furthermore, I created a new page on the presentation. Concerning the regression, I added year-fixed effects and clustered standard errors. In the original document, unemployment wasn't an independent variable alone. I changed that, too. A further paragraph about the results was added in the next section.
...
While extending Joachim's paper, I further find a positive and significant association^[See regression output.] between life expectancy and unemployment. This is quite surprising. However, including the ln of the National Income per Capita (Model (2) and (3)) changes the sign of the coefficient. The coefficient of unemployment is negative when country and year fixed-effects are included.
...
I am new to R and the concept of open science. However, i think it is very important to make research replicable in order to bring research forward. Many interesting papers describe the process of generating the results quite shortly and thus, I am already a fan of using GitHub. Nevertheless, as I was used to Stata, getting familiar with R Studio was a bit of work.
